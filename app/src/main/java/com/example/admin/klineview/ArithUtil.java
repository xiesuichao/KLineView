...
public class ArithUtil {
    ...
    public static String setPrecision(String num, int scale){
    ...
    public static String setPrecision(Float num, int scale){
        BigDecimal bigDecimal = new BigDecimal(num);
        return bigDecimal.setScale(scale, BigDecimal.ROUND_DOWN).toPlainString();
    }
    ...
    public static String sub(String v1, String v2, int scale) {
        try {
            BigDecimal b1 = new BigDecimal(v1);
            BigDecimal b2 = new BigDecimal(v2);
            return b1.subtract(b2).setScale(scale, BigDecimal.ROUND_DOWN).toString();
        } catch (Exception e){
            return "0";
        }
    }
    ...
    public static double mulReturnDouble(String v1, String v2) {
        try {
            BigDecimal b1 = new BigDecimal(v1);
            BigDecimal b2 = new BigDecimal(v2);
            return b1.multiply(b2).setScale(8, BigDecimal.ROUND_DOWN).doubleValue();
        } catch (Exception e) {
            return 0;
        }
